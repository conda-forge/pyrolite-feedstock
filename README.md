...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyrolite-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14933&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyrolite-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyrolite` can be installed with:

```
conda install pyrolite
```

It is possible to list all of the versions of `pyrolite` available on your platform with:
